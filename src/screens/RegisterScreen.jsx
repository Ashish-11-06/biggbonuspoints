...
const RegisterScreen = ({navigation}) => {
  ...
  const validateFields = () => {
    ...
    if (!mobileRef.current) {
      ...
      mobileRef.current.length !== 10 ||
      !/^\d+$/.test(mobileRef.current)
    ) {
    ...
    // Validate Security Answer
    if (
      !referenceAnswerRef.current &&
      referenceQuestionRef.current === 'emp_id'
    ) {
        ...
        <ScrollView
          ...
          <View style={styles.container}>
            ...
            <TextInput
              ...
              onChangeText={text =>
                (mobileRef.current = text.replace(/[^0-9]/g, ''))
              }
              maxLength={10}
              error={!!mobileError}
              style={styles.input}
            ...
            <View style={styles.nameContainer}>
              <View style={styles.halfInput}>
                <TextInput
                  ...
                  mode="outlined"
                  onChangeText={text =>
                    (pinRef.current = text.replace(/[^0-9]/g, ''))
                  }
                  maxLength={4}
                  error={!!pinError}
                  style={styles.input}
              ...
              <View style={styles.halfInput}>
                <TextInput
                  ...
                  mode="outlined"
                  onChangeText={text =>
                    (confirmPinRef.current = text.replace(/[^0-9]/g, ''))
                  }
                  maxLength={4}
            ...
            {securityQuestionError ? (
              <Text style={styles.errorText}>{securityQuestionError}</Text>
            ) : null}
            ...
            />
            {securityAnswerError ? (
              <Text style={styles.errorText}>{securityAnswerError}</Text>
            ) : null}
            ...
            {userType === 'merchant' && (
              <>
                ...
                {referenceQuestionError ? (
                  <Text style={styles.errorText}>{referenceQuestionError}</Text>
                ) : null}
                ...
                {referenceAnswerError ? (
                  <Text style={styles.errorText}>{referenceAnswerError}</Text>
                ) : null}
              </>
            )}
            ...
            {otpSent && (
              <>
                <TextInput
                  ...
                  keyboardType="numeric"
                  onChangeText={text =>
                    (otpRef.current = text.replace(/[^0-9]/g, ''))
                  }
                  maxLength={6}
                  error={!!otpError}
                  style={styles.input}
